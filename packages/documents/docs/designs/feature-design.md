...
OffPathは母国語のレビューが存在しない「真の隠れ名所」だけを厳選し、現地人に愛される本物の体験を予測不可能な旅程で提供する旅行サービスです。AIが現地語レビューを解析し、観光客がまだ知らない高評価スポットを発見します。
...
#### 機能概要
- サービスの価値提案を伝える
- ユーザーの問題意識（「また同じような観光地巡り」「本当に美味しい現地料理が食べたい」）への共感喚起
- 認証ページへの導線
