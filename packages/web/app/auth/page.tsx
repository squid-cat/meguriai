...
import { Compass, Chrome, UserCheck, ArrowLeft } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-amber-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">冒険を始めましょう</h1>
          <p className="text-gray-600">アカウントを作成して、真の隠れ名所を発見</p>
        </div>

        <Card className="border-orange-200 shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-xl">ログイン方法を選択</CardTitle>
            <CardDescription>お好みの方法でサービスを開始してください</CardDescription>
          </CardHeader>
