...
import { Compass, Plus, MapPin, Clock, Star, Globe, Zap, TrendingUp } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-amber-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        {/* Welcome Section */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">おかえりなさい、冒険者！</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card className="border-orange-200">
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-orange-600 mb-1">{stats.totalTrips}</div>
              <div className="text-sm text-gray-600">総旅行数</div>
            </CardContent>
          </Card>
          <Card className="border-orange-200">
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-orange-600 mb-1">{stats.hiddenSpotsFound}</div>
              <div className="text-sm text-gray-600">発見した隠れ名所</div>
            </CardContent>
          </Card>
          <Card className="border-orange-200">
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-orange-600 mb-1">{stats.countriesExplored}</div>
              <div className="text-sm text-gray-600">探検した国</div>
            </CardContent>
          </Card>
          <Card className="border-orange-200">
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-orange-600 mb-1">{stats.chaosScore}</div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-orange-200">
              <CardHeader>
                ...
                <CardDescription>AIが厳選した隠れ名所で、予測不可能な旅を計画しましょう</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                {recentTrips.map((trip) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <Badge
                        variant={trip.status === "完了" ? "default" : "secondary"}
                        className={
                          trip.status === "完了" ? "bg-green-100 text-green-800" : "bg-orange-100 text-orange-800"
                        }
                      >
                        {trip.status}
                      </Badge>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-600">東南アジアで3つの未開拓エリア発見</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-600">現地評価4.8以上の隠れ家レストラン</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-orange-200">
              <CardHeader>
                <CardTitle className="text-lg">コミュニティハイライト</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                ...
                <div className="text-sm">
                  ...
                  <div className="text-gray-600">「想像を超える体験でした」</div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-orange-200 bg-gradient-to-br from-orange-50 to-red-50">
              <CardHeader>
                <CardTitle className="text-lg text-orange-800">冒険のヒント</CardTitle>
              </CardHeader>
              <CardContent>
